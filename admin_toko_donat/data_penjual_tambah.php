              ...
              <div class="panel-body">
                <form role="form" action="data_penjual_tambah_db.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select type="text" name="nama_kategori" class="form-control" aria-label="label for the select">
                  ...
                  <div class="form-group">
                    <label>Harga</label>
                    <select type="number" name="harga" class="form-control" aria-label="label for the select" placeholder="Harga">
